  ...
  return (
    <div className="relative  my-10 flex  flex-col items-center justify-center">
      ...
      <div className="px-4 py-10 md:py-20">
        ...
        >
        Deliver instant, accurate medical assistance through natural voice concversations. Automate appointment scheduling, sympton triage, and follow-up care-24/7
        </motion.p>
        <motion.div
          initial={{
            opacity: 0,
